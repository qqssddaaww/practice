...
public class MainController {
    ...
    public List<MainHotelDTO> getHotelByCName(@RequestParam String name) { return hotelService.getHotelByCName(name); }

    // 현지인이 만든 native page 뽑기 -> 가격기준 내림차순 : 사진, 호텔 이름 , 가격 , 방 이름
    @GetMapping(value = "/get-native-page")
    public List<MainNativePageDTO> getNativePage() { return nativePageService.getNativePage(); }
}
